  ...
  return (
    <div className="min-h-screen bg-[#fbf7f0] text-[#2f2a25]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-5 pt-14 pb-12 md:pt-24 md:pb-20 text-center">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <p className="uppercase tracking-[0.35em] text-sm text-[#8a6a44] mb-3">Together with our families & friends</p>
            ...
            <a
              href="#details"
              className="mt-6 inline-flex flex-col items-center text-[#8a6a44] hover:text-[#3b3028] transition"
            >
